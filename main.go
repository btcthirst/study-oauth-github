...
var (
	...
	oauthConf = &oauth2.Config{
		ClientID:     "Iv1.8778b002ffb20cb0",
		ClientSecret: "6fdb1210f16f200d5e044d458e5ce8984ca41dc6",
...
func handleGitHubCallback(w http.ResponseWriter, r *http.Request) {
	...
	user, _, err := client.Users.Get(oauth2.NoContext, "btcthirst") //.Users.Get("btcthirst")
	if err != nil {
